#!/usr/bin/env bash
# ==============================================================================
#  Runner for curated ocean downscaling pelagic NetCDF to Parquet export
#
...
echo "Submitting curated ocean product pelagic Parquet export jobs by subtree:"
