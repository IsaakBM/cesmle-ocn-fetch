...
echo "============================================================"
echo "Filling hindcast baseline coastal gaps"
...
for var in "${VAR_LIST[@]}"; do
  ...
  for infile in "${files[@]}"; do
    ...
    outfile="${OUT_ROOT}/${rel_path}"
    tmp_out="${out_dir}/.$(basename "${outfile}" .nc).tmp.nc"
...
echo
echo "Finished filling hindcast baseline coastal gaps."
